...
Version  : 23.08.5
Release  : 61
URL      : https://download.kde.org/stable/release-service/23.08.5/src/kollision-23.08.5.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.5/src/kollision-23.08.5.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.5/src/kollision-23.08.5.tar.xz.sig
...
%prep
%setup -q -n kollision-23.08.5
cd %{_builddir}/kollision-23.08.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708391060
mkdir -p clr-build
pushd clr-build
