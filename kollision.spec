...
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/kollision-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/kollision-24.08.0.tar.xz.sig
...
%setup -q -n kollision-24.08.0
cd %{_builddir}/kollision-24.08.0
pushd ..
cp -a kollision-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724516465
mkdir -p clr-build
pushd clr-build
