...
Version  : 22.12.2
Release  : 47
URL      : https://download.kde.org/stable/release-service/22.12.2/src/kollision-22.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.2/src/kollision-22.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.2/src/kollision-22.12.2.tar.xz.sig
...
%prep
%setup -q -n kollision-22.12.2
cd %{_builddir}/kollision-22.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675647456
mkdir -p clr-build
pushd clr-build
