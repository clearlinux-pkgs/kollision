...
Source0  : https://download.kde.org/stable/release-service/23.04.3/src/kollision-23.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.3/src/kollision-23.04.3.tar.xz.sig
...
%prep
%setup -q -n kollision-23.04.3
cd %{_builddir}/kollision-23.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688848744
mkdir -p clr-build
pushd clr-build
