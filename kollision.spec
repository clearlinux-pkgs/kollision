...
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/kollision-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/kollision-24.05.1.tar.xz.sig
...
%setup -q -n kollision-24.05.1
cd %{_builddir}/kollision-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718398932
mkdir -p clr-build
pushd clr-build
