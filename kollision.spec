...
Source0  : https://download.kde.org/stable/release-service/24.08.1/src/kollision-24.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.1/src/kollision-24.08.1.tar.xz.sig
...
%setup -q -n kollision-24.08.1
cd %{_builddir}/kollision-24.08.1
pushd ..
cp -a kollision-24.08.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726176388
mkdir -p clr-build
pushd clr-build
