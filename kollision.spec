...
Version  : 19.04.3
Release  : 9
URL      : https://download.kde.org/stable/applications/19.04.3/src/kollision-19.04.3.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.3/src/kollision-19.04.3.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.3/src/kollision-19.04.3.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562877367
mkdir -p clr-build
pushd clr-build
...
cp COPYING %{buildroot}/usr/share/package-licenses/kollision/COPYING
cp COPYING.DOC %{buildroot}/usr/share/package-licenses/kollision/COPYING.DOC
pushd clr-build
%make_install
popd
%find_lang kollision
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/kollision/COPYING
/usr/share/package-licenses/kollision/COPYING.DOC
